...
export type SubmenuQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  submenuHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SubmenuQuery = {
...
export type CollectionQuery = {
  collection?: StorefrontAPI.Maybe<
    ...
    > & {
      image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'altText' | 'url'>>;
      products: {
        nodes: Array<
...
interface GeneratedQueryTypes {
  '#graphql\n  query Submenu(\n    $country: CountryCode\n    $submenuHandle: String!\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    menu(handle: $submenuHandle) {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: SubmenuQuery;
    variables: SubmenuQueryVariables;
  };
